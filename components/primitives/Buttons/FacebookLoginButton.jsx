...
const FacebookLoginButton = ({ onClick }) => {
    return (
        <>
            <button className='btn fb-button pt-2 pb-2' onClick={onClick}>
                <TextForButtons><i className='fab fa-facebook-f fa-lg mr-2'></i> Iniciar sesión con facebook</TextForButtons>
            </button>
            <style jsx>{`
                .fb-button {
                    padding-right: 16px;
